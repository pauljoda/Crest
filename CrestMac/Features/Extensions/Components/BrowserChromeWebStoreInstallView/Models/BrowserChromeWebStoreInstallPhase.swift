enum BrowserChromeWebStoreInstallPhase {
    case unavailable
    case preparing
    case installed(String)
    case review(BrowserChromeWebStoreCandidate, errorDescription: String?)
    case failed(String)
    ...
    ) -> BrowserChromeWebStoreInstallPhase {
    ...
    var candidate: BrowserChromeWebStoreCandidate? {
