...
class ProductSiteTests(unittest.TestCase):
    ...
    def test_support_page_is_actionable_and_linked(self) -> None:
        ...
        self.assertIn("https://github.com/pauljoda/Crest/issues/new/choose", self.support)
        self.assertIn("https://github.com/pauljoda/Crest/security/advisories/new", self.support)
    ...
    def test_early_access_and_community_links_are_branded_and_safe(self) -> None:
        ...
        self.assertIn("https://ko-fi.com/pauljoda", self.homepage)
