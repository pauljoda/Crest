...
- [x] [Add an About section for build, updates, and community links](https://github.com/pauljoda/Crest/issues/7)
...
- [x] [Add a default page zoom setting](https://github.com/pauljoda/Crest/issues/20)
...
- [x] [Restore navigation history when reopening archived tabs](https://github.com/pauljoda/Crest/issues/30)
- [x] [Keep native window controls reachable in full screen](https://github.com/pauljoda/Crest/issues/31)
- [x] [Preserve navigation when content blocking redirects](https://github.com/pauljoda/Crest/issues/36)
