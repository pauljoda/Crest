...
struct BrowserLegacyTabGroupID: Codable, Hashable, Sendable {
    let rawValue: Int
}

enum BrowserLegacyTabGroupColor: String, Codable, CaseIterable, Sendable {
...
struct BrowserLegacyTabGroup: Codable, Equatable, Sendable {
    let id: BrowserLegacyTabGroupID
    var folderID = FolderID()
    let spaceID: SpaceID
    var tabs: [TabID]
    var title: String?
    var color: BrowserLegacyTabGroupColor = .grey
