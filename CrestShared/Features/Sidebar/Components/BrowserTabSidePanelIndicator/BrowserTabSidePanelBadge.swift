...
struct BrowserTabSidePanelBadge: View {
    ...
    var body: some View {
        if let presentation = sidePanel?.sidePanelPresentation(forTab: tabID, in: spaceID) {
            BrowserTabSidePanelArtwork(
                ...
                size: BrowserTabSidePanelIndicatorMetrics.badgeArtworkSize * scale
            )
            ...
            .offset(
                x: BrowserTabSidePanelIndicatorMetrics.badgeOverhang * scale,
                y: BrowserTabSidePanelIndicatorMetrics.badgeOverhang * scale
            )
    ...
    private var diameter: CGFloat {
        BrowserTabSidePanelIndicatorMetrics.badgeDiameter * scale
    }
}
